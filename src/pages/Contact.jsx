  ...
  return (
    <section className="p-8 md:p-12 bg-gray-50">
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-8">
        Need a Chiller Van? Contact Fresh & Cool Transport!
      </h2>
      <div className="flex flex-col md:flex-row justify-between bg-white p-6 rounded-lg shadow-lg">
        <div className="md:w-1/2">
          <p className="text-gray-700 mb-6 leading-relaxed p-2 ">
            ...
            Get in touch with Fresh & Cool Transport for expert guidance on chiller
          ...
          <div className="mb-4">
            ...
            <p className="text-gray-700">+971 58 889 7885</p>
          </div>
          <div className="mb-4">
      ...
      <div className="mt-12 bg-white p-6 rounded-lg shadow-lg">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Fresh & Cool Transport?</h2>
