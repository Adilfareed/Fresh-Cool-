...
import hiace from "../../../public/assets/hiacechiller.jpg"
const features = [
  {
...
const services = [
  ...
  "Hire Chiller Van without Driver",
  "Chiller Chiller Van with Driver",
  "Delivery van for Rent in Dubai",
  "Rent on a Daily, Weekly & Monthly Basis",
  "Most Suitable Prices for the Chiller Van"
];
  ...
  return (
    <section className="container mx-auto px-6 py-12 ">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          <h2 className="text-blue-600 font-semibold">Hire Chiller Van For Rent in Dubai</h2>
          <h1 className="text-2xl font-bold mt-2 text-gray-800">Looking toward a valid Chiller Van for rent organization in Dubai?</h1>
          <p className="text-gray-600 mt-4">
            Our Chiller Van has an excellent cooling system, so its container keeps whatever kind of stock stays fresh, frozen if you want it, and healthy. We package and deliver your goods anywhere in Dubai. At Chiller Van Transport, we care for customers’ needs, hence why we try to give the best feasible service.
          </p>
      ...
      <div className="text-center mt-12">
        <h2 className="text-blue-600 font-semibold">Chiller Van Services Frozen Food Transport</h2>
        <h1 className="text-2xl font-bold text-gray-800 mt-2">Available 24/7 During Regular 12 Hours Of Service</h1>
        <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
          We have Toyota Hiace for Chiller Van Rental, with and without driver for rent on daily, weekly and monthly basis. Refrigerated transport capacity up to 1 ton. Get the most suitable prices for the chiller van for rent. Chiller van either freezer van remains best of low supply product transportation up to 1 ton in weight.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-8">
        ...
        <div className="relative">
          <img src="assets/hiacechiller.jpg" alt="Chiller Van" className="w-full rounded-lg shadow-lg" />
